    ...
    <>
      ...
      <section className=" font-weight-bold  sticky-top navdetails">
        <nav className="navbar navbar-expand-lg  navbar-light ">
          <a className="nav-link d-sm-none" href="dcahome">
            <i
              class="fa fa-home"
              aria-hidden="true"
            ...
            <ul className="navbar-nav mr-auto links">
              <li className="nav-item dropdown">
                ...
                <div className="dropdown-menu" aria-labelledby="navbarDropdown">
                  <a
                    ...
                    href="dca mainmenu/dca objectives"
                  >
                    Objectives of DCA
                  </a>
                  <a
                    className="nav-link-dropdown "
                    href="dca mainmenu/dca statuteimplemented"
                  >
                    Statute Implemented
                  </a>
                  <a
                  ...
                  <a
                    className="nav-link-dropdown "
                    href="dca mainmenu/dca clientscharter"
                  >
                    Clients Charter
                  </a>
                  <a
              ...
              <li className="nav-item dropdown">
                ...
                <div className="dropdown-menu" aria-labelledby="navbarDropdown">
                  <a
                    className="nav-link-dropdown "
                    href="dca publicservices/dca bloodbanks"
                  >
                    Blood Banks
                  </a>
                  <a
                  ...
                  <a
                    className="nav-link-dropdown"
                    href="dca publicservices/dca banneddrugs"
                  >
                    Banned Drugs
                  </a>
                </div>
